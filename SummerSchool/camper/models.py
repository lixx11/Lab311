...
class Profile(models.Model):
    ...
    major_rank = models.IntegerField(verbose_name='专业排名', blank=True,
                                     null=True)
    class_number = models.IntegerField(verbose_name='班级人数', blank=True,
                                       null=True)
    class_rank = models.IntegerField(verbose_name='班级排名', blank=True,
                                     null=True)
    ...
    fund_applied = models.CharField(verbose_name='是否申请资助',
                                    ...
                                    max_length=128, blank=True, null=True)
    fund_application_text = models.TextField(verbose_name='资助申请理由',
                                             blank=True, null=True)
    ...
    fund_status = models.CharField(verbose_name='资助审核结果',
